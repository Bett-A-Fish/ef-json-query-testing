...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.DynamicField", b =>
                {
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.DynamicListItem", b =>
                {
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.DynamicListType", b =>
                {
                    b.Property<int>("DynamicListTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.DynamicMediaInformation", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("FieldId"), new[] { "Value", "MediaId" });
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.Media_Dynamic", b =>
                {
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.Media_Json", b =>
                {
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.DynamicField", b =>
                {
                    b.HasOne("ef_json_query_testing.Models.DynamicListType", "DynamicListType")
                        .WithMany()
            ...
            modelBuilder.Entity("ef_json_query_testing.Models.DynamicMediaInformation", b =>
                {
                    b.HasOne("ef_json_query_testing.Models.DynamicField", "Field")
                        .WithMany()
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ef_json_query_testing.Models.Media_Dynamic", "Media")
